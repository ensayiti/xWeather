    ...
    return (  
        <Box>
            <Typography variant="h4" mt={5} color="primary.main">
                {name}
                <Typography variant="h5" component="span">, {sys?.country}</Typography>
            </Typography>
            ...
            <Typography component="p" mb={5}>
                Min: {main?.temp_main}°c | Max: {main?.temp_max}°c
            </Typography>
                        ...
                        return (
                            <Grid item xs={6} sm={3} key={id}>
                                ...
                                <Box mt={1.5}>
                                    ...
                                    <Typography component="p" fontWeight="500">{num}{unit}</Typography>
                                </Box>
                            </Grid>
                        );
                    })
